...
export default function Showcase() {
    return (
        <>
            ...
            <div className="col space-2 mx-1 md:mx-2">
                <div>
                    <div className="row space md:space-2 wrap">
                        ...
                        <div className="basis-1/2 md:basis-1/3 grow row border h-min mx-1 sm:mx-2 md:mx-0">
                            <img
                ...
                <div>
                    ...
                    <p>
                        ...
                        developer, primarily as a Frontend developer with
                        tendency for Fullstack.
                    </p>
